{{ Form::model($news,array('url'=>slink::createAuthLink('news/update/'.$news->id),'class'=>'smart-form','id'=>'news-form','role'=>'form','method'=>'post','files'=>TRUE)) }}
			...
			<div class="well">
				...
				@if(Allow::valid_access('downloads'))
					<section>
						...
						<div class="note">
							Новое изображение заменит старое
						</div>
					</section>
				@endif
					<section>
						...
						<label class="input"> <i class="icon-append fa fa-calendar"></i>
							{{ Form::text('date_publication',myDateTime::swapDotDateWithoutTime($news->date_publication),array('data-dateformat'=>'dd.mm.yy','class'=>'datepicker','id'=>'date_publication','data-mask'=>'99.99.9999')) }}
						</label>
					</section>
					<section>
