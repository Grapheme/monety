...
<fieldset>
	<section>
		...
		<div class="note">
			...
			<strong>Если поле оставить пустым</strong>, адрес будет установлен как транстлит названия новости
		</div>
	</section>
	<section>
		...
		<div class="note">
			<strong>Если поле оставить пустым</strong>, атрибут будет установлен как названия новости
		</div>
	</section>
	<section>
