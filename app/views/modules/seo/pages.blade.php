...
<fieldset>
	<section>
		@if(Page::count() || isset($page) && !$page->start_page)
			...
			<div class="note">
				...
				<strong>Если поле оставить пустым</strong>, адрес будет установлен как транстлит названия страницы
			</div>
		@else
	...
	<section>
		...
		<div class="note">
			<strong>Если поле оставить пустым</strong>, атрибут будет установлен как названия страницы
		</div>
	</section>
	<section>
