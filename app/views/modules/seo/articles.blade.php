...
<fieldset>
	<section>
		...
		<div class="note">
			...
			<strong>Если поле оставить пустым</strong>, адрес будет установлен как транслит названия статьи
		</div>
	</section>
	<section>
		...
		<div class="note">
			<strong>Если поле оставить пустым</strong>, атрибут будет установлен как название статьи
		</div>
	</section>
	<section>
