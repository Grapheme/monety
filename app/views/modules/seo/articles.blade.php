...
<fieldset>
	<section>
		...
		<div class="note">
			...
			<strong>Если поле оставить пустым</strong>, адрес будет установлен как транстлит названия статьи
		</div>
	</section>
	<section>
		...
		<div class="note">
			<strong>Если поле оставить пустым</strong>, атрибут будет установлен как названия статьи
		</div>
	</section>
	<section>
