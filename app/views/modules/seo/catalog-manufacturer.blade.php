...
<fieldset>
	<section>
		<label class="label">Адрес страницы производителя (URL)</label>
		<label class="input">
		...
		<div class="note">
			...
			<strong>Если поле оставить пустым</strong>, адрес будет установлен как транслит названия производителя
		</div>
	</section>
	<section>
		...
		<div class="note">
			<strong>Если поле оставить пустым</strong>, атрибут будет установлен как название производителя
		</div>
	</section>
	<section>
