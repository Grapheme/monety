...
<fieldset>
	<section>
		<label class="label">Адрес страницы категории (URL)</label>
		<label class="input">
		...
		<div class="note">
			...
			<strong>Если поле оставить пустым</strong>, адрес будет установлен как транстлит названия категории
		</div>
	</section>
	<section>
		...
		<div class="note">
			<strong>Если поле оставить пустым</strong>, атрибут будет установлен как названия категории
		</div>
	</section>
	<section>
